-- Bateria de testes do LOBBY. Espelha a do Match (src-match/server/Tests) de propósito: mesmo
...
--   NÃO pega: física, rede, streaming, GUI, comportamento emergente em Play. Nada aqui prova que o
--             lobby "monta party bem" — prova que as peças que decidem isso não estão quebradas.
